...
def train_supervised_bidomain():
    ...
    sim_state_dict = torch.load("/home/ubuntu/22dat.dh/drif_workspace_corl2019/models/tmp/supervised_clipunet_stage1_bidomain_clipunet_stage1_aug1-2_sim_epoch_6.pytorch")
    real_state_dict = torch.load("/home/ubuntu/22dat.dh/drif_workspace_corl2019/models/tmp/supervised_clipunet_stage1_bidomain_clipunet_stage1_aug1-2_real_epoch_6.pytorch")
    critic_state_dict = torch.load("/home/ubuntu/22dat.dh/drif_workspace_corl2019/models/tmp/supervised_pvn_stage1_critic_clipunet_stage1_aug1-2_critic_epoch_6.pytorch")
    
    model_sim.load_state_dict(sim_state_dict, strict = False)
    model_real.load_state_dict(real_state_dict, strict = False)
    model_critic.load_state_dict(critic_state_dict, strict = False)
