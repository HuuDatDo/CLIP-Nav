...
class Lseg_Stage1_Bidomain(nn.Module):

    def __init__(self, run_name="", domain="sim"):

        super(Lseg_Stage1_Bidomain, self).__init__()
        ...
        self.lseg = LSeg(head = nn.Sequential(
    ...
    def load_state_dict(self, state_dict, strict=True):
        super(Lseg_Stage1_Bidomain, self).load_state_dict(state_dict, strict)
    ...
    def reset(self):
        ...
        self.lseg.pretrained.model.leaky_integrator_global_map.reset()
        self.prev_instruction = None
