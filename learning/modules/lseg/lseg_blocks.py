...
def _make_encoder(
    ...
    elif backbone == "clip_vitb32_rn50_384":
        clip_pretrained, pretrained = _make_pretrained_clip_vitb_rn50_384(
            use_pretrained,
            hooks=[0, 1, 8, 11],
            use_readout=use_readout
        )
...
def _make_scratch(in_shape, out_shape, groups=1, expand=False):
    ...
    # scratch.head1 = nn.Conv2d(features, self.out_c, kernel_size=1)
